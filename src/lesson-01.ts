export default class calculator {
     ...
     */
     users: Array<{name: string, email: string}> = [
        {name: 'Vass Gábor', email: 'vass.gabor.sandor@gmail.com'},
        {name: 'Szekrényes Emőke', email: 'szekrenyes.emoke@gmail.com'}
    ]
     ...
     */    
     products: Array<{name: string, price: number, stock: number, active?: boolean}> = [
        {name: 'Túró rudi', price: 150, stock: 1950, active: true},
        {name: 'Dunakavics', price: 240, stock: 23}
    ]
     ...
     */
     role: [number, string, boolean] = [1, 'something', true]
